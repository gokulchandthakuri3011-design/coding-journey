...
- [x] Understanding Syntax errors vs runtime Exceptions
- [x] `try`, `except`, `else`, `finally` blocks
- [x] Catching specific exceptions (`ValueError`, `ZeroDivisionError`, `FileNotFoundError`)
- [x] Raising exceptions (`raise`) and exception chaining
...
- [x] **Project: Build a Contact Book CLI App**
